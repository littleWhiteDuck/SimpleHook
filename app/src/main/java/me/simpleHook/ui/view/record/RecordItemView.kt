...
class RecordItemView(context: Context) : CustomViewGroup(context) {
    init {
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        icon.autoMeasure()
        readState.measure(
            readState.defaultWidthMeasureSpec(this),
            readState.defaultHeightMeasureSpec(this)
        )
        val textViewWidth =
            measuredWidth - icon.measuredWidthWithMargins - readState.measuredWidthWithMarginsPaddings
        title.measure(
    ...
    override fun onLayout(p0: Boolean, p1: Int, p2: Int, p3: Int, p4: Int) {
        ...
        readState.autoLayout(
            readState.marginRight,
            readState.toVerticalCenter(this),
            fromRight = true
        )
    }
}
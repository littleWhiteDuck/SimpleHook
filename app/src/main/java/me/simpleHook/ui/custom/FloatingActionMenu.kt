...
class FloatingActionMenu(context: Context, attrs: AttributeSet) :
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        setMeasuredDimension(
            menuButton.measuredWidth / 2 + width,
            height + menuButton.measuredHeightWithMargins
        )
    }
    ...
    override fun onLayout(changed: Boolean, l: Int, t: Int, r: Int, b: Int) {
        ...
        children.forEach {
            if (it !is FloatingActionButton) {
                it.autoLayout(
                    menuButton.measuredWidth / 2 -
                            (it as me.simpleHook.ui.custom.FloatingActionButton).actionButton.measuredWidth / 2,

...
abstract class RecordDatabase: RoomDatabase() {
    ...
    companion object {
        ...
        private val REQUIRED_RECORD_COLUMNS_V7 = REQUIRED_RECORD_COLUMNS_V6 + setOf(
            "summaryTitle",
            "summarySubtitle",
            "summaryMeta"
        )
        ...
        private val MIGRATION_6_7 = object : Migration(6, 7) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE RecordEntity ADD COLUMN summaryTitle TEXT DEFAULT NULL")
                db.execSQL("ALTER TABLE RecordEntity ADD COLUMN summarySubtitle TEXT DEFAULT NULL")
                db.execSQL("ALTER TABLE RecordEntity ADD COLUMN summaryMeta TEXT DEFAULT NULL")
            }
        }
        ...
        private fun hasValidRecordSchema(db: SQLiteDatabase): Boolean {
            val requiredColumns = when {
                db.version >= 7 -> REQUIRED_RECORD_COLUMNS_V7
